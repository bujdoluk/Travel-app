...
<body class="antialiased tracking-normal overflow-x-hidden">
    <section class="fixed w-full z-30 mb-12">
        <!-- Banner -->
                        ...
                        <div class="sm:relative sm:w-full sm:py-12 flex flex-col">
                            ...
                            <div class="sm:absolute sm:left-8 sm:right-8 sm:-bottom-4 bg-white sm:w-auto h-auto rounded p-4">
                                <div class="inline-flex font-bold uppercase">
                                    ...
                                    <p class="text-gray-600 p-1">{{ $product->bathroom }} bathroom</p>
                                </div>
                                <p class="font-bold text-2xl sm:py-2">{{$product->name}}</p>
                                <p class="text-xl sm:pb-3 sm:pt-2">{{$product->price}}$<span class="text-gray-600">/wk</span></p>
                                <div class="inline-flex">
                                    ...
                                    <p class="text-xl text-gray-600 pl-2 -mb-1.5">{{ $product->reviews }} Reviews</p>
                                </div>
                            </div>
                        </div>
                    </a>
        ...
        <div class="modal-container bg-white w-11/12 md:max-w-md mx-auto rounded shadow-lg z-50 overflow-y-auto">
            ...
            <div class="modal-content py-4 text-left px-6">
                ...
                <div class="flex justify-end pt-2">
                    <button class="px-4 bg-transparent p-3 rounded-lg text-indigo-500 hover:bg-gray-100 hover:text-indigo-400 mr-2">Shop</button>
