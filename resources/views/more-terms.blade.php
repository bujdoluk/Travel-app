...
<section class="container mx-auto">
    <div class="py-10 px-20">
        <div class="flex justify-between border-b border-blue-200 pb-5">
            <h2 class="text-2xl">Terms</h2>
        </div>

        <h2 class="font-bold lg:text-3xl pb-4 pt-5">Lorem ipsum dolor sit amet.</h2>
        <p class="pb-10 text-justify">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Sed voluptate nihil eum consectetur similique?
            Consectetur, quod, incidunt, harum nisi dolores delectus reprehenderit voluptatem perferendis dicta
            dolorem non blanditiis ex fugiat. Lorem ipsum dolor sit amet, consectetur adipisicing elit.
        </p>
        <p class="text-justify">
            Lorem ipsum dolor sit amet, consectetur adipisicing elit. Et, consequuntur, modi mollitia corporis
            ipsa voluptate corrupti eum ratione ex ea praesentium quibusdam? Aut, in eum facere corrupti necessitatibus
            perspiciatis quis.
        </p>
    </div>

    <div class="py-10 px-20">
        <h2 class="font-bold lg:text-3xl pb-4">Lorem ipsum dolor sit amet.</h2>
        <p class="pb-10 text-justify">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Sed voluptate nihil eum consectetur similique?
            Consectetur, quod, incidunt, harum nisi dolores delectus reprehenderit voluptatem perferendis dicta
            dolorem non blanditiis ex fugiat. Lorem ipsum dolor sit amet, consectetur adipisicing elit.
        </p>
