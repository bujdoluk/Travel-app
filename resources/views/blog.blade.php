...
<section class="container mx-auto px-8 sm:px-20 py-8 sm:py-20">
    <div class="flex flex-wrap items-start">
        <div class="sm:w-2/3 w-full sm:w-full xl:w-2/3">
            ...
            <div class="xl:grid xl:grid-cols-2 sm:grid sm:grid-cols-1 sm:gap-0 xl:gap-8 w-full">
                ...
                <div class="w-full">
                    <a href="{{ route('blog.show', $blog->slug) }}">
                        <img class="sm:w-full xl:w-full" src="/{{$blog->img}}" alt="Blog">
                        <h2 class="px-10 pt-6 pb-2 text-center text-indigo-500 text-2xl font-bold">{{$blog->title}}</h2>
                    </a>
            ...
            <!-- Pagination -->
<!--            <div class="flex w-full items-center justify-center space-x-4 pt-8 select-none sm:pb-10 xl:pb-0">
