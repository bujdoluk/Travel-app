...
<section class="relative">
    <img src="https://raw.githubusercontent.com/bujdoluk/travelapp/master/public/images/heading-2-1920x500.jpg" alt="Image" class="h-full w-full opacity-50 relative">
                    ...
                    <div class="my-1  w-full md:w-1/2 lg:my-4 lg:px-2 lg:w-1/3">
                        <article class="overflow-hidden rounded-b-lg shadow-lg">
                            ...
                            <header class="flex items-center justify-between leading-tight p-2 md:p-4">
                                <h1 class="text-lg">{{ $package->name }}</h1>
