...
<section class="container mx-auto">
    ...
    <div class="xl:py-10 sm:py-5 flex flex-wrap sm:px-20 px-8">
        ...
        <div class="xl:w-2/5">
            <img class="xl:block w-full h-auto sm:hidden" src="https://raw.githubusercontent.com/bujdoluk/Travel-website/master/public/images/team_01.jpg" alt="Image">
            <p class="text-center py-6 font-bold text-2xl sm:hidden xl:block">John Doe</p>
        </div>
    </div>
</section>
